...
public class Ruangtamu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.menu_ruang_tamu);
    ...
    private class ConnectBT extends AsyncTask<Void, Void, Void>  // UI thread
    {
        ...
        {
            progress = ProgressDialog.show(Ruangtamu.this, "Connecting...", "Please wait");  //show a progress dialog
        }
    ...
    public void onBackPressed() {
        ...
        Intent intentkamar2 = new Intent(Ruangtamu.this,MainActivity.class);
