...
public class Kamar1 extends AppCompatActivity {
    Switch switchButton1,switchButton2,switchButton3;
    ImageView off1,off2,off3;
    String address = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kamar_1);
        ...
        off3=(ImageView)findViewById(R.id.imageView9);
        ...
        switchButton3.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener(){
            ...
            public void onCheckedChanged(CompoundButton compoundButton,boolean bChecked){
                if(bChecked){
                    off3.setImageResource(R.drawable.open);
                    if (btSocket!=null)
                    {
                        try
                        {
                            btSocket.getOutputStream().write("PB".toString().getBytes());
                        }
                        catch (IOException e)
                        {
                            msg("Error");
                    ...
                    off3.setImageResource(R.drawable.closed);
                    if (btSocket!=null)
                    {
                        try
                        {
                            btSocket.getOutputStream().write("PT".toString().getBytes());
                        }
                        catch (IOException e)
                        {
                            msg("Error");
    ...
    private class ConnectBT extends AsyncTask<Void, Void, Void>  // UI thread
    {
        ...
        {
            progress = ProgressDialog.show(Kamar1.this, "Connecting...", "Please wait");  //show a progress dialog
        }
    ...
    public void onBackPressed() {
        ...
        Intent intentkamar2 = new Intent(Kamar1.this,MainActivity.class);
