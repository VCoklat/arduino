...
public class Kamar2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kamar_2);
    ...
    private class ConnectBT extends AsyncTask<Void, Void, Void>  // UI thread
    {
        ...
        {
            progress = ProgressDialog.show(Kamar2.this, "Connecting...", "Please wait");  //show a progress dialog
        }
    ...
    public void onBackPressed() {
        ...
        Intent intentkamar2 = new Intent(Kamar2.this,MainActivity.class);
