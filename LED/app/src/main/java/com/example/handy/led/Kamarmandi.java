...
public class Kamarmandi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kamar_mandi);
    ...
    private class ConnectBT extends AsyncTask<Void, Void, Void>  // UI thread
    {
        ...
        {
            progress = ProgressDialog.show(Kamarmandi.this, "Connecting...", "Please wait");  //show a progress dialog
        }
    ...
    public void onBackPressed() {
        ...
        Intent intentkamar2 = new Intent(Kamarmandi.this,MainActivity.class);
